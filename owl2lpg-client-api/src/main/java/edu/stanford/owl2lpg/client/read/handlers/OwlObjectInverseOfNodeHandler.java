 ...
 */
public class OwlObjectInverseOfNodeHandler implements NodeHandler<OWLObjectInverseOf> {
  ...
  @Inject
  public OwlObjectInverseOfNodeHandler(@Nonnull OWLDataFactory dataFactory,
  ...
  public String getLabel() {
    return NodeLabels.OBJECT_INVERSE_OF.getMainLabel();
  }
