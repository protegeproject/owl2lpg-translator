 ...
 */
public class OwlAnnotationPropertyNodeHandler implements NodeHandler<OWLAnnotationProperty> {

  @Nonnull
  private final OWLDataFactory dataFactory;

  @Inject
  public OwlAnnotationPropertyNodeHandler(@Nonnull OWLDataFactory dataFactory) {
