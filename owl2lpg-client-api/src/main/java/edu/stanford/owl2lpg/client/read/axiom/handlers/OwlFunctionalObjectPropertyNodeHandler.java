 ...
 */
public class OwlFunctionalObjectPropertyNodeHandler implements NodeHandler<OWLFunctionalObjectPropertyAxiom> {
  ...
  @Inject
  public OwlFunctionalObjectPropertyNodeHandler(@Nonnull OWLDataFactory dataFactory,
  ...
  public String getLabel() {
    return NodeLabels.FUNCTIONAL_OBJECT_PROPERTY.getMainLabel();
  }

  @Override
  public OWLFunctionalObjectPropertyAxiom handle(Node mainNode, NodeIndex nodeIndex, NodeMapper nodeMapper) {
    ...
    return dataFactory.getOWLFunctionalObjectPropertyAxiom(property, annotations);
  }
}
