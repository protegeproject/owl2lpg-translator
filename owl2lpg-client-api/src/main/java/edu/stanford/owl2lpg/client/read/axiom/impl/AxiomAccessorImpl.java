...
public class AxiomAccessorImpl implements AxiomAccessor {
  ...
  private static final String ANNOTATION_AXIOM_BY_REFERENCING_IRI_QUERY_FILE = "read/axioms/annotation-axiom-by-referencing-iri.cpy";
  ...
  private static final String ANNOTATION_AXIOM_BY_REFERENCING_IRI_QUERY = read(ANNOTATION_AXIOM_BY_REFERENCING_IRI_QUERY_FILE);
  ...
  public ImmutableSet<OWLAxiom> getAllAxioms(@Nonnull ProjectId projectId,
    ...
    var inputParams = Parameters.forContext(ontoDocId);
  ...
  public <T extends OWLAxiom> ImmutableSet<T> getAxiomsByType(@Nonnull AxiomType<T> axiomType,
                                                              ...
                                                              @Nonnull BranchId branchId,
                                                              @Nonnull OntologyDocumentId ontoDocId) {
    var inputParams = Parameters.forAxiomType(axiomType, ontoDocId);
  ...
  public boolean containsAxiom(@Nonnull OWLAxiom owlAxiom,
    ...
    var inputParams = Parameters.forNodeDigest(digest, ontoDocId);
  ...
  public ImmutableSet<OWLAxiom> getAxiomsBySignature(@Nonnull OWLEntity entitySignature,
                                                     ...
                                                     @Nonnull BranchId branchId,
                                                     @Nonnull OntologyDocumentId ontoDocId) {
    var inputParams = createInputParams(entitySignature, ontoDocId);
  ...
  getAxiomsBySubject(@Nonnull OWLClass subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_CLASS_QUERY, subject, ontoDocId);
  }
  ...
  getAxiomsBySubject(@Nonnull OWLDataProperty subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_DATA_PROPERTY_QUERY, subject, ontoDocId);
  }
  ...
  getAxiomsBySubject(@Nonnull OWLObjectProperty subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_OBJECT_PROPERTY_QUERY, subject, ontoDocId);
  }
  ...
  getAxiomsBySubject(@Nonnull OWLAnnotationProperty subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_ANNOTATION_PROPERTY_QUERY, subject, ontoDocId);
  }
  ...
  getAxiomsBySubject(@Nonnull OWLNamedIndividual subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_NAMED_INDIVIDUAL_QUERY, subject, ontoDocId);
  }
  ...
  getAxiomsBySubject(@Nonnull OWLDatatype subject,
                     ...
                     @Nonnull BranchId branchId,
                     @Nonnull OntologyDocumentId ontoDocId) {
    return getAxiomsBySubject(AXIOM_BY_SUBJECT_DATATYPE_QUERY, subject, ontoDocId);
  }

  @Nonnull
  private ImmutableSet<OWLAxiom> getAxiomsBySubject(String queryString, OWLEntity subject, OntologyDocumentId ontoDocId) {
    var inputParams = createInputParams(subject, ontoDocId);
  ...
  getAnnotationAxioms(@Nonnull IRI entityIri,
                      ...
                      @Nonnull BranchId branchId,
                      @Nonnull OntologyDocumentId ontoDocId) {
    var inputParams = createInputParams(entityIri, ontoDocId);
    var nodeIndex = graphReader.getNodeIndex(ANNOTATION_AXIOM_BY_REFERENCING_IRI_QUERY, inputParams);
  ...
  getSubAnnotationPropertyOfAxiomsBySuperProperty(@Nonnull OWLAnnotationProperty superProperty,
                                                  ...
                                                  @Nonnull BranchId branchId,
                                                  @Nonnull OntologyDocumentId ontoDocId) {
    var inputParams = createInputParams(superProperty, ontoDocId);
  ...
  @Nonnull
  private static Value createInputParams(OWLEntity entity, OntologyDocumentId ontoDocId) {
    return createInputParams(entity.getIRI(), ontoDocId);
  }

  @Nonnull
  private static Value createInputParams(IRI entityIri, OntologyDocumentId ontoDocId) {
    return Parameters.forEntityIri(entityIri, ontoDocId);
  }
}
