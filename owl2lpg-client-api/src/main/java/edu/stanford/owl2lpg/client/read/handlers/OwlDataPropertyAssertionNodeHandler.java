 ...
 */
public class OwlDataPropertyAssertionNodeHandler implements NodeHandler<OWLDataPropertyAssertionAxiom> {
  ...
  @Inject
  public OwlDataPropertyAssertionNodeHandler(@Nonnull OWLDataFactory dataFactory,
  ...
  public String getLabel() {
    return NodeLabels.DATA_PROPERTY_ASSERTION.getMainLabel();
  }

  @Override
  public OWLDataPropertyAssertionAxiom handle(Node mainNode, NodeIndex nodeIndex, NodeMapper nodeMapper) {
