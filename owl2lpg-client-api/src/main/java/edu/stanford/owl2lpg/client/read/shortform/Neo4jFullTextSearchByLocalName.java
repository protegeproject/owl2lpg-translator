 ...
 */
public class Neo4jFullTextSearchByLocalName implements Neo4jFullTextSearch {

  private static final String SEARCHABLE_SHORT_FORMS_QUERY_FILE = "shortforms/full-text-search-by-local-name.cpy";
