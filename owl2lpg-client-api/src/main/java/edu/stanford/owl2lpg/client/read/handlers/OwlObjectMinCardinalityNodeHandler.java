 ...
 */
public class OwlObjectMinCardinalityNodeHandler implements NodeHandler<OWLObjectMinCardinality> {
  ...
  @Inject
  public OwlObjectMinCardinalityNodeHandler(@Nonnull OWLDataFactory dataFactory,
  ...
  public String getLabel() {
    return OBJECT_MIN_CARDINALITY.getMainLabel();
  }

  @Override
  public OWLObjectMinCardinality handle(Node mainNode, NodeIndex nodeIndex, NodeMapper nodeMapper) {
