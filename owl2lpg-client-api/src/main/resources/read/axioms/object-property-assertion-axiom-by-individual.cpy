CALL {
  MATCH (n:ObjectPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:NamedIndividual {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:NegativeObjectPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:NamedIndividual {iri:$entityIri})
  RETURN n
}
