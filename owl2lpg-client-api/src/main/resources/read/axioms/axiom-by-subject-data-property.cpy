CALL {
  MATCH (n:Declaration)-[:ENTITY]->(:DataProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:DataPropertyAxiom)-[:SUB_DATA_PROPERTY_EXPRESSION|DATA_PROPERTY_EXPRESSION]->(:DataProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:AnnotationAxiom)-[:ANNOTATION_SUBJECT]->(:IRI {iri:$entityIri})
  RETURN n
}
