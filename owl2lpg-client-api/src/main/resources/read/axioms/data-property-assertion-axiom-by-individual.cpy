CALL {
  MATCH (n:DataPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:NamedIndividual {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:NegativeDataPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:NamedIndividual {iri:$entityIri})
  RETURN n
}
