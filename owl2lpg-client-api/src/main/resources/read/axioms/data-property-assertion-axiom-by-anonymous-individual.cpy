CALL {
  MATCH (n:DataPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:AnonymousIndividual {nodeID:$nodeId})
  RETURN n
  UNION
  MATCH (n:NegativeDataPropertyAssertion)-[:SOURCE_INDIVIDUAL]->(:AnonymousIndividual {nodeID:$nodeId})
  RETURN n
}
