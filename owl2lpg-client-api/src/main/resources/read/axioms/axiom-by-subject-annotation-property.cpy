CALL {
  MATCH (n:Declaration)-[:ENTITY]->(:AnnotationProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:AnnotationAxiom)-[:SUB_ANNOTATION_PROPERTY|ANNOTATION_PROPERTY]->(:AnnotationProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:AnnotationAssertion)-[:ANNOTATION_SUBJECT]->(:IRI {iri:$entityIri})
  RETURN n
}
