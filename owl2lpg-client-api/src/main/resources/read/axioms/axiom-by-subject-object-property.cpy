CALL {
  MATCH (n:Declaration)-[:ENTITY]->(:ObjectProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:Axiom)-[:SUB_OBJECT_PROPERTY_EXPRESSION|OBJECT_PROPERTY_EXPRESSION]->(:ObjectProperty {iri:$entityIri})
  RETURN n
  UNION
  MATCH (n:Axiom)-[:ANNOTATION_SUBJECT]->(:IRI {iri:$entityIri})
  RETURN n
}
