CALL {
   ...
   MATCH (entity:AnnotationProperty { iri: $subjectIri })<-[:AXIOM_SUBJECT]-(axiom)
   ...
   MATCH (entity:AnnotationProperty)-[:ENTITY_IRI]->(:IRI { iri: $subjectIri })<-[:AXIOM_SUBJECT]-(annotation)
